.PHONY: init test clean build-image init-minikube dev-webapp dev-webapp-ts tunnel clean-webapp help
...
tunnel:  ## Create a tunnel to access the webapp
	@echo "Creating a tunnel to access the webapp..."
	@echo "Note: Make sure you have in otterdog.local entry in /etc/hosts. For example:"
	@echo "127.0.0.1 localhost otterdog.local"
	@echo ""
	@minikube tunnel
